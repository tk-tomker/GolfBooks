...
export default function ContactUsPage() {
  ...
  return (
    ...
    <main className="flex items-center justify-center align-center h-[calc(100vh-64px)] bg-gradient-to-b from-gray-100 to-white-100">
        <Card className="w-100 h-58 self-center text-center bg-[white]  hover:backdrop-blur transition-all duration-200 hover:bg-[#1e3a32] hover:text-white hover:scale-105">
            <CardHeader>
